...
Retrieve the explained variance to determine how much information can be attributed to each principal component and confirm the total explained variance of the three principal components.
